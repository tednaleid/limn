...
- change file extension from .mindmap to .limn to match Obsidian plugin
...
- turn into obsidian plugin, similar to excalidraw, this is likely the place where I'll use this the most
    - investigate what needs to be separated out from the browser version we have now, storage concerns for json/images, etc
